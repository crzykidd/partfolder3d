...
> **Status:** alpha (v0.7.3) — see [`README.md`](README.md) and [`PRD.md`](PRD.md).
> Full stack is built and shipping; v0.7.3 is the current release on `main`
> (v0.1.1–v0.7.3 tagged), with `dev` == `main` between releases.
