...
| Manyfold connector (Part 1 of 3 — config + admin API only; connector/worker in Part 2, frontend in Part 3) | `manyfold.py` | `manyfold.py` (`ManyfoldInstance`) | — (Part 2) | `storage/manyfold_client.py` (`fetch_token`/`get_access_token`, OAuth2 client_credentials) | — (Part 3) | — (Part 3) | `test_manyfold_admin.py` |
