...
# ---------------------------------------------------------------------------
# Share-link import stub (Phase 7)
# ---------------------------------------------------------------------------
...
async def import_from_share_link(
    ...
    """STUB — Import from another PartFolder 3D instance's share link.

    This endpoint is a placeholder. Full instance-to-instance import will be
    implemented in Phase 7.
    """
    raise HTTPException(
        status_code=status.HTTP_501_NOT_IMPLEMENTED,
        detail="Share-link import is not yet available (planned for Phase 7).",
    )
