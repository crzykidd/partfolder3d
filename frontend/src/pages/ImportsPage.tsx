...
// ---------------------------------------------------------------------------
// Commit-ready panel: bulk-commit all pending_wizard sessions
// ---------------------------------------------------------------------------
...
function BulkResultSummary({ result, onClose }: BulkResultSummaryProps) {
...
function CommitReadyPanel({ pendingCount, libraries, settings }: CommitReadyPanelProps) {
  const queryClient = useQueryClient()
